# 1.1 ¿Quienes son mis aprendices? 🔮
______
...
!!! tip
    ...
    _Cuando diseñamos lecciones o unidades de aprendizaje no debemos preguntarnos **“¿es esto importante?”**, en su lugar debemos preguntarnos **“¿entendería la persona por qué hacemos esto?”**_.
...
Wilson () comenta que para entender a nuestros estudiantes no basta con ser empáticos; es necesario un proceso analítico que nos permita definir la carga cognitiva y el tipo de contenido a diseñar. 
